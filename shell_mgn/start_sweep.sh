...
nohup wandb sweep --project shell_mgn_sweep_v1 shell_mgn/conf/sweep.yaml > "$file_name" 2>&1 &
...
nohup wandb agent --project shell_mgn_sweep_v1 --entity malaikanoor7864-mnsuam "$sweep_id" >> "$file_name" 2>&1 &
